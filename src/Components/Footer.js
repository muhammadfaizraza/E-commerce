...
const Footer = () => {
 ...
 we first made waves in Pakistan’s e-commerce market after its introduction in 2012. Our vision was to provide a safe, a smooth online shopping experience guaranteed.</p>
...
Purchase Protection
                  ...
                  <div>
                      <div>Chat with our Virtual AI Bot(24/7 Live Agent Support)   <div className='Icons'>     {facebookIcon} {youtubeIcon} {instagramIcon} {twitterIcon} </div>
  </div><button>CHAT NOW</button>
                  </div>
       ...
       <div className='FooterLast'> Copyright © 2010  All Rights Reserved</div>
        </div>
